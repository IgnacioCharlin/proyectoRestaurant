...
public class Pedido implements Comparable<Pedido> {
	...
	private HashSet<Bebida>bebidasEnElPedido;
	private Mesa mesa;
	private Mozo mozo;
	...
	public Pedido(Integer numeroDePedido, Mesa mesa, Mozo mozo) {
		...
		bebidasEnElPedido = new HashSet<Alimento>();
	}
	...
	public Boolean agregarBebidaAlPedido(Bebida nuevo , Restaurant actual) {
		for (Bebida bebida : actual.getCarta()) {
			if (nuevo.getDescripcion().equals(bebida.getDescripcion())) {
				return bebidasEnElPedido.add(nuevo);
			}
		}
		return false;
	}
